...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    private List<Leilao> leiloesDeExemplo() {
        ...
        console.propoe(new Lance(new Usuario("Joaquim"), 100.0));
        console.propoe(new Lance(new Usuario("Fernando"), 200.0));

        Leilao computador = new Leilao("Computador");
        computador.propoe(new Lance(new Usuario("Joaquim"), 300.0));
        computador.propoe(new Lance(new Usuario("Fernando"), 800.0));
        computador.propoe(new Lance(new Usuario("Pedro"), 900.0));
        computador.propoe(new Lance(new Usuario("Maria"), 980.0));
